    ...
    <div class="flex flex-col items-center">
        @if ($rated)
            <div class="mt-6 text-center">
                <p class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-pink-500 to-red-500 animate-pulse">
        ...
        @else
            ...
            <button type="submit"
                class="cursor-pointer mt-6 bg-gradient-to-r from-yellow-500 to-pink-500 text-white font-semibold py-2 px-6 rounded-full hover:scale-105 transition-transdiv duration-300 shadow-md"
