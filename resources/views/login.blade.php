                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                ...
                                placeholder="Tarantino" required="">
                        </div>
                        <div>
                            <label for="secretKey"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Secret Key</label>
                            <input type="password" name="secretKey" id="secretKey" placeholder="••••••••"
                                class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required="">
                            ...
                            <div class="mt-6 p-4 bg-blue-900/20 border border-blue-500 rounded-lg flex items-start">
                                ...
                                <div>
                                    <p class="text-sm text-blue-100">
                                        <span class="font-bold">Secret key was issued to you when you registered.</span>
                                    </p>
                                </div>
                            </div>
                        </div>
