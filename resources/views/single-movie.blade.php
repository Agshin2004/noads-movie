...
<div class="max-w-screen-lg mx-auto p-4 sm:p-8">
    ...
    {{-- Movie Header --}}
    <div class="flex flex-col sm:flex-row items-center bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 p-6 rounded-xl shadow-lg">
        ...
        <div class="sm:ml-8 mt-6 sm:mt-0 text-center sm:text-left">
            <h1 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-500 mb-2">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start gap-2 mb-4">
                @foreach ($movie['genres'] as $genre)
                    <span class="bg-gradient-to-r from-pink-500 to-red-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                        {{ $genre }}
                    </span>
                @endforeach
            </div>
    ...
    {{-- Cast --}}
    <div class="mt-12">
        <h2 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-center mb-10">
            Cast
        </h2>
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
            @foreach ($movie['credits'] as $actor)
            <a href="{{ route('person', ['personId' => $actor['id']]) }}">    
                <div class="text-center bg-gray-800/40 rounded-lg p-4 hover:scale-105 transition-transform duration-300">
